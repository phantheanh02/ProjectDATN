...
public:
	...
	// copy constructor
	Matrix(const Matrix& other) { memcpy(m, other.m, sizeof(m)); };
	...
	Matrix& SetOrthographic(GLfloat nearPlane, GLfloat farPlane, GLfloat left, GLfloat right, GLfloat top, GLfloat bottom);
